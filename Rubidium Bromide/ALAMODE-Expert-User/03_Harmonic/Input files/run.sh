...
aprun -d 36 -j 1 --cc depth $ADIR/alm/alm RbBr_alm1.in1 > RbBr_alm1.log1

python $ADIR/tools/displace.py --VASP=RbBr222.opt --mag=0.04 RbBr222.pattern_HARMONIC
...
python $ADIR/tools/extract.py --VASP=RbBr222.opt vasprun*.xml > DFSET_harmonic

aprun -d 36 -j 1 --cc depth $ADIR/alm/alm RbBr_alm1.in2 > RbBr_alm1.log2
aprun -d 36 -j 1 --cc depth $ADIR/anphon/anphon RbBr_band.in > RbBr_band.log