...
srun -N 1 -n 1 -c 128 $ADIR/alm/alm MoSe_alm2.in1 > MoSe_alm2.log1

python $ADIR/tools/displace.py --VASP=MoSe881.opt --mag=0.04 MoSe881.pattern_ANHARMO3
...
python $ADIR/tools/extract.py --VASP=MoSe881.opt vasprun*.xml > DFSET_cubic

srun -N 1 -n 1 -c 128 $ADIR/alm/alm MoSe_alm2.in2 > MoSe_alm2.log2