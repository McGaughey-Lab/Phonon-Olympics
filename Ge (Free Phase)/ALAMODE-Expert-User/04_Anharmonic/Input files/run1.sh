...
aprun -d 36 -j 1 --cc depth /work/app/ALAMODE/current/alm/alm Ge_alm2.in1 > Ge_alm2.log1

python $ADIR/displace.py --VASP=Ge222.opt --mag=0.06 Ge222.pattern_ANHARM3
...
python $ADIR/extract.py --VASP=Ge222.opt vasprun*.xml > DFSET_cubic

aprun -d 36 -j 1 --cc depth /work/app/ALAMODE/current/alm/alm Ge_alm2.in2 > Ge_alm2.log2